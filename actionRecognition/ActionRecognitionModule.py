...
def actionRecognition(skeletons, dispInfo):
	...
	#CREATE ACTIVITY SEQUENCE
		...
		# print 'f',f
		activitySequence = ActivityFeatureComputation.createActivitySequence(clusters, f)
